...
const DICT: Record<string, Entry> = {
  ...
  'couponsPage.storePage': { ar: 'كل أكواد المتجر', en: 'All store codes' },
  'couponStore.h1':{ ar: 'كود خصم {store} — {my}', en: '{store} discount codes — {my}' },
  'couponStore.subtitle': { ar: '{n} كود فعال ومجرب', en: '{n} active, tested codes' },
  'couponStore.updated': { ar: 'آخر تحديث {date}', en: 'Updated {date}' },
  'couponStore.copyAndShop': { ar: 'انسخ وتسوق', en: 'Copy & shop' },
  'couponStore.none': { ar: 'لا توجد أكواد فعالة لـ {store} حالياً — تحقق لاحقاً', en: 'No active {store} codes right now — check back soon' },
  'couponStore.browseAll': { ar: 'تصفح كل الكوبونات', en: 'Browse all coupons' },
  'couponStore.howTitle': { ar: 'كيف تستخدم كود خصم {store}؟', en: 'How to use a {store} code' },
  'couponStore.how1': { ar: 'انسخ الكود بالضغط على زر النسخ.', en: 'Copy the code with the copy button.' },
  'couponStore.how2': { ar: 'انتقل إلى متجر {store} وأضف منتجاتك إلى السلة.', en: 'Go to {store} and add items to your cart.' },
  'couponStore.how3': { ar: 'في صفحة الدفع، الصق الكود في خانة كود الخصم أو القسيمة.', en: 'At checkout, paste the code into the promo/coupon field.' },
  'couponStore.how4': { ar: 'تأكد من ظهور الخصم في الإجمالي قبل إتمام الطلب.', en: 'Confirm the discount shows in your total before paying.' },
  'couponStore.faqTitle': { ar: 'أسئلة شائعة', en: 'FAQ' },
  'couponStore.q1': { ar: 'هل كود خصم {store} فعال؟', en: 'Does the {store} code work?' },
  'couponStore.a1': { ar: 'نعم — الأكواد المعروضة مُدارة يدوياً ويُزال أي كود تنتهي صلاحيته، والكود الحصري مجرب مع الشريك مباشرة.', en: 'Yes — codes are curated manually and expired ones are removed; exclusive codes are verified directly with the partner.' },
  'couponStore.q2': { ar: 'على ماذا يطبق كود {store}؟', en: 'What does the {store} code apply to?' },
  'couponStore.a2': { ar: 'يوضح وصف كل كود نسبة الخصم وما يشمله. غالباً يُطبق على كامل السلة ما لم يُذكر استثناء في متجر {store}.', en: 'Each code lists its discount and scope. Most apply to the whole cart unless {store} states an exclusion.' },
  'couponStore.q3': { ar: 'الكود لا يعمل، ماذا أفعل؟', en: 'The code is not working — what now?' },
  'couponStore.a3': { ar: 'تأكد من نسخ الكود كاملاً بلا مسافات، وجرب كوداً آخر من القائمة. بعض الأكواد لا تُجمع مع تخفيضات أخرى أو تتطلب حداً أدنى للطلب.', en: 'Make sure it is pasted with no spaces and try another code from the list. Some codes cannot stack with other sales or need a minimum order.' },
  'couponStore.related': { ar: 'متاجر أخرى بأكواد خصم', en: 'More stores with codes' },
